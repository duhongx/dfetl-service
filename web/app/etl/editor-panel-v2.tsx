  ...
  switch (request.kind) {
    ...
    case "target": {
      ...
      return {
        ...
        feHosts: endpoints.map((endpoint) => endpoint.host),
        feQueryPorts: endpoints.map((endpoint) => endpoint.queryPort),
        feHttpPorts: endpoints.map((endpoint) => endpoint.httpPort),
      };
    }
    case "route": {
