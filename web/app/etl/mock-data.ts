...
export const taskSeed: TaskRow[] = [
  { id: "TASK-1001", name: "县人民医院-患者基本信息", institutionCode: "330106001", institutionName: "县人民医院", datasetCode: "ODS_YL_HUANZHEJBXX", datasetName: "患者基本信息", datasetVersion: 3, routeId: "R001", routeVersion: 7, taskKind: "FULL_THEN_INCREMENTAL", writeMode: "UPSERT", keyModel: "UNIQUE_KEY", incrementalField: "XIUGAISJ", scheduleMode: "EVERY_N_HOURS", scheduleLabel: "每 4 小时 · 00:17 起", scheduleEnabled: true, validationOverride: "INHERIT", watermark: "2026-08-17 08:17:00", state: "READY" },
  { id: "TASK-1002", name: "县人民医院-检查申请单", institutionCode: "330106001", institutionName: "县人民医院", datasetCode: "ODS_YL_APP_JIANCHASQD", datasetName: "检查申请单", datasetVersion: 5, routeId: "R004", routeVersion: 5, taskKind: "FULL_THEN_INCREMENTAL", writeMode: "UPSERT", keyModel: "UNIQUE_KEY", incrementalField: "XIUGAISJ", scheduleMode: "CRON", scheduleLabel: "0 15 */4 * * ?", scheduleEnabled: true, validationOverride: "ROW_COUNT", watermark: "2026-08-17 08:15:00", state: "RUNNING" },
  { id: "TASK-1003", name: "县中医院-患者基本信息", institutionCode: "330106002", institutionName: "县中医院", datasetCode: "ODS_YL_HUANZHEJBXX", datasetName: "患者基本信息", datasetVersion: 3, routeId: "R003", routeVersion: 3, taskKind: "FULL_THEN_INCREMENTAL", writeMode: "UPSERT", keyModel: "UNIQUE_KEY", incrementalField: "XIUGAISJ", scheduleMode: "MANUAL", scheduleLabel: "人工", scheduleEnabled: false, validationOverride: "ROW_COUNT_CHECKSUM", watermark: null, state: "DISABLED" },
];
